    ...
    <>
      ...
      <div className="flex flex-col gap-y-10 justify-center mt-4">
        <button
          ...
          className="px-4 py-2 bg-message text-textColor_primary rounded-lg hover:bg-backgroundDull font-semibold border border-borderColor_primary flex items-center gap-x-2 w-fit mx-auto"
        >
          {isPlaying && !isPaused ? (
